...
**Interactive Features.** We may offer interactive features such as review forums, commenting functionalities, blogs, and social media pages. We and others who use our Services may collect the information you submit or make available through these interactive features. Any content you provide on the public sections of these features will be considered “public” and is not subject to the privacy protections referenced herein. By using these interactive features, you assume the risk that the personal information provided by you may be viewed and used by third parties for their own purposes.
...
We may obtain information about you from other sources, including from third party services and organizations. For example, if you access our Services through a third-party application, such as a social networking site, we may collect information about you from that third-party application that you have made available via your privacy settings.
...
**To Provide the Services or Information Requested, such as:**
  - Fulfilling our contract with you (i.e., fulfilling and managing your order);
...
**Brands.** When you place an order, you are instructing Darkstore to share your personal information with the Brand whose products you have purchased. Once your personal information has been shared with the Brand, it will also be subject to the Brand’s privacy policy and the Brand may use your personal information for its own purposes, including to send you marketing materials. We encourage you to closely read the Brand’s privacy policy before placing an order. Please note that we do not control and we are not responsible for the Brand’s processing of your personal information. 
